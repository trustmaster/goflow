...
func TestBuild_Connection(t *testing.T) {
	...
	def := Definition{
		...
		Exports: []ExportDef{
			{Kind: ExportOutPort, Public: "OUT", Proc: "R", Port: "Out"},
		},
	}
...
func TestBuild_IIP(t *testing.T) {
	...
	def := Definition{
		...
		IIPs: []IIPDef{
			{Data: 99, Tgt: Endpoint{Process: "R", Port: "In"}},
		},
		Exports: []ExportDef{
			{Kind: ExportOutPort, Public: "OUT", Proc: "R", Port: "Out"},
		},
...
func TestBuild_ArrayPort(t *testing.T) {
	...
	def := Definition{
		...
		Connections: []ConnectionDef{
			{
				Src: Endpoint{Process: "S", Port: "Out"},
				Tgt: Endpoint{Process: "R", Port: "In", Index: &idx},
			},
		},
		Exports: []ExportDef{
			{Kind: ExportOutPort, Public: "OUT", Proc: "R", Port: "Out"},
...
func TestBuild_InPortExport(t *testing.T) {
	...
	def := Definition{
		...
		Exports: []ExportDef{
			{Kind: ExportInPort, Public: "IN", Proc: "R", Port: "In"},
			{Kind: ExportOutPort, Public: "OUT", Proc: "R", Port: "Out"},
		},
	}
...
func TestBuild_ErrorUndeclaredProcessInConnection(t *testing.T) {
	...
	def := Definition{
		...
		Connections: []ConnectionDef{
			{
				Src: Endpoint{Process: "S", Port: "Out"},
				Tgt: Endpoint{Process: "Missing", Port: "In"},
			},
		},
	}
...
func TestBuild_ErrorUndeclaredProcessInIIP(t *testing.T) {
	...
	def := Definition{
		Processes: map[string]ProcessDef{},
		IIPs: []IIPDef{
			{Data: 1, Tgt: Endpoint{Process: "Missing", Port: "In"}},
		},
	}
...
func TestBuild_ErrorExportUnknownProcess(t *testing.T) {
	...
	def := Definition{
		Processes: map[string]ProcessDef{},
		Exports: []ExportDef{
			{Kind: ExportInPort, Public: "X", Proc: "Missing", Port: "In"},
		},
	}
...
func TestBuild_MultipleProcessesAndConnections(t *testing.T) {
	...
	def := Definition{
		...
		Connections: []ConnectionDef{
			{Src: Endpoint{Process: "S", Port: "Out"}, Tgt: Endpoint{Process: "R1", Port: "In"}},
			{Src: Endpoint{Process: "R1", Port: "Out"}, Tgt: Endpoint{Process: "R2", Port: "In"}},
		},
		Exports: []ExportDef{
			{Kind: ExportOutPort, Public: "OUT", Proc: "R2", Port: "Out"},
		},
	}
